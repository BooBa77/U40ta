...
Модуль `Home` представляет собой главную страницу приложения U40TA, содержащую основной функционал для работы с ведомостями, почтовыми вложениями и управлением режимом работы.
